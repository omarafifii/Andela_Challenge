...
api_secret = '4vrqxr9466bkne567kf2kgxf'
zip_code = '78701'
...
engine = sqlalchemy.create_engine(
    'mysql+mysqlconnector://omar:omar@localhost:3306/sqlalchemy',
    echo=True)
...
def get_data_from_api(api_secret,zip_code,start_date,line_up_id,date_time):
    ...
    # r1_df_final.genres = r1_df_final['genres'].fillna({i: [] for i in r1_df_final.index})
